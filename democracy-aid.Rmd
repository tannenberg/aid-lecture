...
author: "Marcus Tannenberg | SK1214 | `r Sys.Date()` "
output:
...
background-image: url(input/front-map.png)
...
### Hur påverkar internationellt bistånd demokrati? 

.large[**Marcus Tannenberg**| SK1214 | `r Sys.Date()`]
...
- **Del 1** Vad är demokratibistånd? Och fungerar det? 

- *15 min paus*

- **Del 2** Bistånd från auktoritära regimer
...
## Var passar internationellt bistånd in i kursen? 
...
knitr::include_graphics("input/democracy-aid-trend.png")
```
...
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/democracy-aid-trend2.png")
```
...
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/row_2017.png")
```
...
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/oecd-aid-row.png")
```
...
knitr::include_graphics("input/oecd-world.png")
```
---

# Democracy aid at 25 (Carothers 2015)
...
## Utsikterna för demokratibistånd 1990: golden age

- Utökning av antal demokratier
...
- Trump ("America First", dictator cuddling) 

--

Kan inte längre anta att demokrati är önskvärt i mottagarlandet.
...
- Positiv men svag effecekt för tidsperioden 2001-2014

- Skillnad i effektstorlek sker runt 2001

- [länk till USAID-rapporten](https://dec.usaid.gov/dec/GetDoc.axd?ctID=ODVhZjk4NWQtM2YyMi00YjRmLTkxNjktZTcxMjM2NDBmY2Uy&rID=NTEyMTYw&pID=NTYw&attchmnt=True&uSesDM=False&rIdx=MjY2NTA1&rCFU=)
...
- Ingen biståndsmyndighet (fram tills nyligen)
...
---
# Kinesiskt bistånd till Afrika

```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/china-africa-log.png")
```
...
```{r out.width = '80%', echo=FALSE}
knitr::include_graphics("input/china-world-log.png")
```
...
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/china-aid-row.png")
```
...
## Vem får auktoritärt bistånd?
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/gwf_map_2010.png")
```
...
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/china-aid-gwf.png")
```


---

# Vad vet vi om effekterna av auktoritärt biståndet? 
...
## Does conditionality still work? - Li (2017)
```{r out.width = '70%', echo=FALSE}
knitr::include_graphics("input/xiaojunli.png")
```
---

## Are “New” Donors Challenging World Bank Conditionality? Hernandez (2017)

- Världsbanken kräver färre conditionalities från mottagarländer som har tillgång till Kinesiskt kapital
...
background-image: url(input/cn-rouge-aid.jpg)
background-size: cover
...
knitr::include_graphics("input/melania.jpg")
```
---
...
- En modell att sträva efter

- För 40 levde de flesta i Kina i fattigdom (88%)  

- Snabbaste fattigdomsbekämpning i historien (idag 2%)

- Världens största ekonomi

- I 36 Afrikanska länder anger 24% att Kinas utvecklingsmodell är bäst
...
- Auktoritära biståndsprojekt borde ha en inverkan om du kommer i kontakt med dem, tex besöker ett sjukhus
...
- Kinas bistånd är *bra* -> Kinesiskt bistånd associerat med *lägre* stöd för demokrati
...
Respondenter som bor nära (inom 40km) kinesiska projekt är: 
...
- Har det ändrats över tid?


---

# Biståndsdata
Bistånd (även auktoritärt):
...
### Extra:
- "Development Aid From Dictators: Damaging for Democracy?" Annals of Comp. Democratization 17(2) 2019. Bermeo, Bader, Hackenesch, Parks, Strange and Tannenberg  [link](https://gallery.mailchimp.com/195d6bf7bad75a3ef81189778/files/96ee2113-2c81-44e2-905d-6c7309e7e3e7/APSA_June2019.pdf)
